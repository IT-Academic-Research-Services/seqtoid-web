class SfnPipelineDataService
  ...
  SFN_STEP_TO_DAG_STEP_NAME = {
    ...
    PipelineRunStage::ALIGNMENT_STAGE_NAME => {
      "RunAlignment_minimap2_out" => "minimap2_out",
      "RunCallHitsMinimap2" => "minimap2_call_hits_out",
      "RunAlignment_diamond_out" => "diamond_out",
      "RunCallHitsDiamond" => "diamond_call_hits_out",
