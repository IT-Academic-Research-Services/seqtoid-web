...
import { TableRenderers } from "~/components/common/TableRenderers/TableRenderers";
import NarrowContainer from "~/components/layout/NarrowContainer";
import { BaseDiscoveryView } from "~/components/views/DiscoveryView/components/BaseDiscoveryView";
import { DiscoveryMap } from "~/components/views/DiscoveryView/components/DiscoveryMap";
import { DiscoveryViewToggle } from "~/components/views/DiscoveryView/components/DiscoveryViewToggle";
...
export class ProjectsView extends React.Component<ProjectsViewProps> {
  columns: $TSFixMe;
